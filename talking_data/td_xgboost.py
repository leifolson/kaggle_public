...
def read_train_test():
    ...
    # Events
    print('Read events...')
    events = pd.read_csv("/Users/clint/Development/data/talking_data/events.csv", dtype={'device_id': np.str})
    events['counts'] = events.groupby(['device_id'])['event_id'].transform('count')
    events_small = events[['device_id', 'counts']].drop_duplicates('device_id', keep='first')

    # Phone brand
    print('Read brands...')
    pbd = pd.read_csv("/Users/clint/Development/data/talking_data/phone_brand_device_model.csv", dtype={'device_id': np.str})
    ...
    # Test
    print('Read test...')
    test = pd.read_csv("/Users/clint/Development/data/talking_data/gender_age_test.csv", dtype={'device_id': np.str})
